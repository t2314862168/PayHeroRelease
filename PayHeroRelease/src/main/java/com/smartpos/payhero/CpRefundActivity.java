...
import com.smartpos.payhero.databinding.ActivityCpRefundBinding;
...
public class CpRefundActivity extends AppCompatActivity implements NextClickCallback {

    private ActivityCpRefundBinding mBinding;
    MockData mockData;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_cp_refund);
    ...
    private void trade(String transId, String orderId, String merchantName, String amt, String originalIdTxn, String ext1, String ext2) {
        ...
        //封装请求消息
        BLCPRefundMsg sdkMsg = new BLCPRefundMsg();
        //支付交易号
        ...
        final BLPaymentRequest<BLCPRefundMsg> params = new BLPaymentRequest<>();
        params.data = sdkMsg;

        BillPayment.startPayment(CpRefundActivity.this, params, new BillPaymentCallback() {
            @Override
            public void onSuccess(String successData) {
                Log.i("callback", "onSuccess");
                Log.i("response", successData);

                Utils.handleCallback(CpRefundActivity.this, successData);
            }
            ...
            public void onFailed(String failedData) {
                ...
                Utils.handleCallback(CpRefundActivity.this, failedData);
            }
            ...
            public void onCancel(String cancelData) {
                ...
                Utils.handleCallback(CpRefundActivity.this, cancelData);
            }
        });
    }
